def format_matches_for_gpt(matches):
    ...
    for idx, study in enumerate(matches, 1):
        rationale_text = "; ".join(study.get('match_reason', [])) or 'No specific rationale provided.'
        ...
        output += f"- **Contact**: {study['contact_name']} | {study['contact_email']} | {study['contact_phone']}\n"
